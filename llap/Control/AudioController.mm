...
struct CallbackData {
    ...
    CallbackData(): rioUnit(NULL), rangeFinder(NULL) , audioChainIsBeingReconstructed(NULL), canSendData(false), dataOutStream(NULL), mtime(0),mUIUpdateTime(0),audioPlayer(NULL),distance(0),distanceChange(0) {}
} cd;
...
- (Float32) distanceChange {
    _distanceChange = cd.distanceChange;
